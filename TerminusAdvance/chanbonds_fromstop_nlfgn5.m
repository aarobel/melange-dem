function chanbonds_fromstop_nlfgn5(runfilename,nt,iter,hsi,str,lfc)
if(iter~=1)
runname = [runfilename '_h' int2str(10*hsi) '_str' num2str(str/1e5) 'e5_lfc' int2str(lfc*1000)]
...
parbnd = struct('ibnd'   ,3,    ...  % whether bond-related info should be written to the header
		...
		'term_radius',...
		     atomdata.r(1450),...
                ...
                'nolf',1);
		[L,r,Rx,Ry,Vx,Vy] = LIGGGHTSinit_bondcreate2(atomdata,bondlist,params,parbnd,['./res/' runname '.restart']);
