function makeLAMMPSrun_nlfgn5(iter,run,hsi,str,lfc)

runname = [run '_h' int2str(10*hsi) '_str' num2str(str/1e5) 'e5_lfc' int2str(lfc*1000)]
...
if(iter==1)
        fprintf(fid,'%s\n',['read_data       ./init/fjordbond_gn500_lgberg_nlf_mbtr0_dmax10.init']);
else
